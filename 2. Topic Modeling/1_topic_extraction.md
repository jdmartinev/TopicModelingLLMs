...
- Mu et al., Large Language Models Offer an Alternative to the Traditional Approach of Topic Modelling
- Tai et al., An Examination of the Use of Large Language Models to Aid Analysis of Textual Data.
- Wen et al., Leveraging large language models for thematic analysis: a case study in the charity sector
